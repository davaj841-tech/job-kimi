...
const routes = [
    ...
    },
    {
        ...
        meta: { title: 'خریدهای من', auth: true },
    },
    {
        path: '/resumes',
        name: 'resumes',
        component: () => import('../views/resume/ResumeListView.vue'),
        meta: { title: 'رزومه‌ها', auth: true },
    },
    {
        path: '/resumes/:id',
        name: 'resume-edit',
    ...
    },
    {
        ...
        meta: { title: 'کیف پول', auth: true },
    },
    {
        path: '/subscription',
        name: 'subscription',
        component: () => import('../views/subscription/PlansView.vue'),
        meta: { title: 'اشتراک', auth: true },
    },
    {
        path: '/profile',
        name: 'profile',
        component: () => import('../views/profile/ProfileView.vue'),
        meta: { title: 'پروفایل', auth: true },
    },
    {
        path: '/notifications',
        name: 'notifications',
        component: () => import('../views/NotificationsView.vue'),
        meta: { title: 'اعلان‌ها', auth: true },
    },
    {
        path: '/terms',
        name: 'terms',
    ...
    },
    {
        ...
        meta: { title: 'تنظیمات اعلان', auth: true },
    },
    {
        path: '/payment/wallet',
        name: 'payment-wallet',
        component: () => import('../views/PaymentResultView.vue'),
        meta: { title: 'نتیجه پرداخت', auth: true, hideNav: true, paymentType: 'wallet' },
    },
    {
        path: '/payment/subscription',
        name: 'payment-subscription',
        component: () => import('../views/PaymentResultView.vue'),
        meta: { title: 'نتیجه پرداخت اشتراک', auth: true, hideNav: true, paymentType: 'subscription' },
    },
    {
        path: '/payment/pdf',
        name: 'payment-pdf',
        component: () => import('../views/PaymentResultView.vue'),
        meta: { title: 'نتیجه خرید PDF', auth: true, hideNav: true, paymentType: 'pdf' },
    },
    {
        path: '/:pathMatch(.*)*',
        name: 'not-found',
