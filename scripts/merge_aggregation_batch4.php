<?php
/**
 * One-shot merge helper — run: php scripts/merge_aggregation_batch4.php
 * Do NOT place under config/ (Laravel loads all config/*.php).
 */

$path = dirname(__DIR__).'/config/aggregation.php';
$content = file_get_contents($path);
$batch = file_get_contents(__DIR__.'/aggregation_batch4_sources.txt');

$marker = "        ['slug'=>'e-estekhdam-government',";
