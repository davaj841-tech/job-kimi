...
Route::middleware(['auth:sanctum', 'user.active', 'subscription.check', 'role:super_admin,admin,operator', 'operator.perm', 'throttle:admin-api'])->prefix('admin')->group(function () {
