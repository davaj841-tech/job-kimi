<template>
  <div class="px-4 py-4">
    <h1 class="mb-4 section-title">پلن‌های اشتراک</h1>
    ...
    <div v-else class="space-y-3">
      ...
      >
        ...
        <div class="flex gap-2">
          <button class="btn-primary flex-1" @click.stop="subscribe(plan.id, 'wallet')">کیف پول</button>
          <button class="btn-ghost flex-1 border border-surface-line" @click.stop="subscribe(plan.id, gateway)">پرداخت آنلاین</button>
        </div>
      </div>
    </div>
