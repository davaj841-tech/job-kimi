<template>
    ...
    <div class="flex items-center justify-between">
      <div>
        ...
        <p class="mt-1 text-sm text-slate-500">
          صفحات با اسلاگ terms، privacy، about و contact در فوتر و سایت نمایش
          داده می‌شوند. معرفی مدیران از بخش پایین همین صفحه در «درباره ما» دیده
          می‌شود.
        </p>
      </div>
    ...
    <div class="mb-4 flex flex-wrap items-center justify-between gap-2">
      <div>
        ...
        <p class="mt-1 text-xs text-slate-500">
          در پایین صفحه درباره ما به صورت ۳ ستون نمایش داده می‌شود: نام، سمت،
          عکس پرسنلی ۳×۴، شرح.
        </p>
      </div>
  ...
  <Teleport to="body">
    <div v-if="modal" class="fixed inset-0 z-[80] flex flex-col bg-slate-100">
      <header
      ...
      <div
        class="mx-auto flex min-h-0 w-full max-w-7xl flex-1 flex-col gap-4 overflow-hidden p-4 lg:flex-row"
      >
        <aside
        ...
        >
          ...
          <p class="text-[11px] leading-5 text-slate-400">
            از نوار ابزار برای تیتر، فهرست، لینک، جدول و تصویر استفاده کنید.
            حالت HTML برای ویرایش دقیق است.
          </p>
        </aside>

        <div
          class="min-h-0 min-w-0 flex-1 overflow-y-auto rounded-2xl border border-slate-200 bg-white p-3"
        >
