    ...
    <div class="space-y-5">
      <div class="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p class="mt-1 text-sm text-slate-500">بکاپ خودکار هر روز ساعت ۳ صبح</p>
        </div>
        <button class="btn-dark" :disabled="creating" @click="create">بکاپ دستی</button>
      </div>
...
<style scoped>
.btn-dark { @apply rounded-xl bg-[#0f2744] px-4 py-2.5 text-sm font-bold text-white disabled:opacity-50; }
