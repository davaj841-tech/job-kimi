...
export const useQuestionsStore = defineStore('adminQuestions', {
  ...
  actions: {
    ...
    async updateQuestion(id: number | string, payload: Record<string, unknown>) {
    ...
    async importQuestions({ file, exam_id }: { file: File; exam_id: number | string }) {
    ...
    async importFromExcel({ file, exam_id }: { file: File; exam_id: number | string }) {
