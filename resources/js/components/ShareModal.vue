    ...
    <div class="w-full max-w-md rounded-2xl bg-white p-5 shadow-xl">
      ...
      <div class="mb-4 grid grid-cols-4 gap-2 text-center text-xs">
        <a
          ...
          target="_blank"
          rel="noopener"
          class="rounded-xl bg-sky-50 py-3 font-bold text-sky-700"
          >تلگرام</a
        >
        <a
          :href="whatsapp"
          target="_blank"
          rel="noopener"
          class="rounded-xl bg-emerald-50 py-3 font-bold text-emerald-700"
          >واتساپ</a
        >
        <a
          :href="twitter"
          target="_blank"
          rel="noopener"
          class="rounded-xl bg-slate-100 py-3 font-bold text-slate-700"
          >X</a
        >
        <button
          type="button"
          class="rounded-xl bg-orange-50 py-3 font-bold text-brand"
          @click="copy"
        >
          کپی لینک
        </button>
