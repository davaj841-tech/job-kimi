    ...
    <div class="mx-auto max-w-7xl px-4">
      ...
      <div class="grid grid-cols-2 gap-px overflow-hidden rounded-2xl bg-surface-line sm:grid-cols-4">
        <RouterLink
          ...
          :key="item.to"
          :to="item.to"
          class="animate-on-scroll group flex flex-col gap-2 bg-white px-4 py-5 transition hover:bg-surface-page sm:px-5 sm:py-6"
        >
          <span
...
const items = [
  {
    to: '/exams',
    label: 'آزمون‌ها',
    desc: 'شبیه‌سازی واقعی و تحلیل نتیجه',
    icon: AcademicCapIcon,
  },
  {
    to: '/jobs',
    label: 'استخدام‌ها',
    desc: 'آگهی‌های تأییدشده و به‌روز',
    icon: BriefcaseIcon,
  },
  {
    to: '/pdfs',
    label: 'منابع PDF',
    desc: 'فایل‌های آموزشی هدفمند',
    icon: DocumentTextIcon,
  },
  {
    to: '/resumes',
    label: 'رزومه‌ساز',
    desc: 'ساخت رزومه استاندارد PDF',
    icon: SparklesIcon,
  },
]
</script>
