<template>
  ...
  >
    ...
    <template v-else-if="name === 'star'">
      <path
        d="m12 2 3.1 6.3L22 9.3l-5 4.9 1.2 7L12 17.8 5.8 21.2 7 14.2 2 9.3l6.9-1L12 2z"
      />
    </template>
    ...
    <template v-else-if="name === 'phone'">
      <path
        d="M22 16.9v3a2 2 0 0 1-2.2 2 19.8 19.8 0 0 1-8.6-3.1 19.5 19.5 0 0 1-6-6A19.8 19.8 0 0 1 2.1 4.2 2 2 0 0 1 4.1 2h3a2 2 0 0 1 2 1.7c.1.8.3 1.6.6 2.3a2 2 0 0 1-.5 2.1L8.1 9.9a16 16 0 0 0 6 6l1.8-1.1a2 2 0 0 1 2.1-.4c.7.3 1.5.5 2.3.6a2 2 0 0 1 1.7 1.9z"
      />
    </template>
    ...
    <template v-else-if="name === 'quote'">
      <path
        d="M3 21c3 0 7-1 7-8V5H4v8h4c0 4-1 6-5 8zM14 21c3 0 7-1 7-8V5h-6v8h4c0 4-1 6-5 8z"
      />
    </template>
    <template v-else-if="name === 'bank'">
      <path d="M3 21h18M5 21V10M19 21V10M12 3l9 7H3l9-7z" />
    ...
    <template v-else-if="name === 'building'">
      ...
      <path d="M9 21v-6h6v6M9 8h.01M15 8h.01M9 12h.01M15 12h.01" />
    </template>
    <template v-else-if="name === 'city'">
      <path d="M3 21h18M5 21V8l5-3v16M14 21V4l5 3v14" />
    </template>
