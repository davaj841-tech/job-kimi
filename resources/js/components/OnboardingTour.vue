  ...
  <Teleport to="body">
    <div v-if="visible" class="fixed inset-0 z-[100]">
      ...
      <div
        ...
        :style="panelStyle"
      >
        <p class="mb-1 text-xs font-bold text-brand">
          گام {{ step + 1 }} از {{ steps.length }}
        </p>
        <h3 class="mb-2 text-lg font-black text-slate-800">
          {{ current.title }}
        </h3>
...
const steps = [
  {
    title: 'به جاب‌آزمون خوش آمدید!',
    body: 'اینجا می‌توانید آزمون بدهید، آگهی ببینید، رزومه بسازید و اشتراک بگیرید.',
    path: '/dashboard',
  },
  {
    title: 'آزمون بده',
    body: 'از بخش آزمون‌ها شروع کنید و کارنامه بگیرید.',
    path: '/exams',
    highlight: true,
  },
  {
    title: 'آگهی استخدام ببین',
    body: 'جدیدترین فرصت‌های شغلی و مهلت ثبت‌نام را دنبال کنید.',
    path: '/jobs',
  },
  {
    title: 'رزومه بساز',
    body: 'با رزومه‌ساز حرفه‌ای، فایل PDF آماده کنید.',
    path: '/resumes',
  },
  {
    title: 'اشتراک بخر',
    body: 'با اشتراک، به همه آزمون‌ها و امکانات ویژه دسترسی دارید.',
    path: '/subscription',
  },
]
