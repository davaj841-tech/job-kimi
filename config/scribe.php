...
return [
    ...
    'title' => 'جاب‌آزمون — مستندات API',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'API نسخه ۱ جاب‌آزمون (آزمون استخدامی، کیف پول، اشتراک و احراز هویت).',

    // Text to place in the "Introduction" section, right after the `description`. Markdown and HTML are supported.
    'intro_text' => <<<'INTRO'
            مستندات API عمومی جاب‌آزمون با پیشوند `/api/v1`.
            ...
            <aside>با اسکرول کردن، نمونه‌کدهای فراخوانی API را در سمت راست می‌بینید. زبان نمونه را از تب‌های بالا می‌توانید عوض کنید.</aside>
        INTRO,
    ...
    'auth' => [
        ...
        'extra_info' => 'توکن را پس از ورود با OTP یا رمز عبور از فیلد `token` در پاسخ دریافت کنید و به‌صورت `Authorization: Bearer {token}` ارسال کنید.',
    ],
